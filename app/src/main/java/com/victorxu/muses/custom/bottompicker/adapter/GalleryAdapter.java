package com.victorxu.muses.custom.bottompicker.adapter;
...
import com.victorxu.muses.custom.bottompicker.BottomSheetDialogFragment;
import com.victorxu.muses.custom.bottompicker.view.SquareFrameLayout;
import com.victorxu.muses.custom.bottompicker.view.SquareImageView;
...
public class GalleryAdapter extends RecyclerView.Adapter<GalleryAdapter.GalleryViewHolder> {
    ...
    private BottomSheetDialogFragment.BaseBuilder builder;
    private OnItemClickListener onItemClickListener;
    private List<Uri> selectedUriList;


    public GalleryAdapter(Context context, BottomSheetDialogFragment.BaseBuilder builder) {
        ...
        try {
            ...
            String orderBy;
            Uri uri;
            if (builder.mediaType == BottomSheetDialogFragment.BaseBuilder.MediaType.IMAGE) {
    ...
    public GalleryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.bottom_picker_grid_item, null);
