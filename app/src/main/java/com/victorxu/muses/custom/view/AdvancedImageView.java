...
public class AdvancedImageView extends AppCompatImageView {
    ...
    private void initAll(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.AdvancedImageView);
        borderRadius = dp2px(array.getDimension(R.styleable.AdvancedImageView_borderRadius, BORDER_RADIUS_DEFAULT));
        type = array.getInt(R.styleable.AdvancedImageView_type, TYPE_NORMAL);
        border_width = dp2px(array.getDimension(R.styleable.AdvancedImageView_borderWidth, BORDER_WIDTH));
        border_color = array.getInt(R.styleable.AdvancedImageView_borderColor, BORDER_COLOR);
        array.recycle();
    }
